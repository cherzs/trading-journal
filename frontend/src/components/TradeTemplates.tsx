  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Trade Templates</h3>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex justify-between">
                <span>Strategy:</span>
                <span className="font-medium text-gray-900 dark:text-white">{template.strategy}</span>
              </div>
              <div className="flex justify-between">
                <span>Type:</span>
                <span className={`font-medium ${template.trade_type === 'long' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                  }`}>
              ...
              <div className="flex justify-between">
                <span>Size:</span>
                <span className="font-medium text-gray-900 dark:text-white">{template.default_size}</span>
              </div>
              <div className="flex justify-between">
                <span>SL/TP:</span>
              ...
              <div className="flex justify-between">
                <span>Timeframe:</span>
                <span className="font-medium text-gray-900 dark:text-white">{template.timeframe}</span>
              </div>
            </div>
          </div>
        ))}
